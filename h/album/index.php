          ...
          <div class="card shadow-sm">
            ...
            <div class="card-body">
              ...
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  <button type="button" class="btn btn-sm btn-outline-success">รายละเอียดสินค้า</button>
                  <button type="button" class="btn btn-sm btn-outline-warning">หยิบลงตะกร้า</button>
                </div>
              </div>
            </div>
          </div>
